        ...
        <form name="form1" method="post" action="#" id="form1">
            ...
            <div class="divr">
                ...
                <div style="width: 100%;display: block;margin: 0 5px 0 5px;">
                    ...
                    <input type="hidden" id="id" value="<?php echo $product_id ?>"/>
                    <div class="wrap-input" style="   width: 720px;">
                        ...
                        <div class="value" style="width: 620px"><input type="text" id="name" 
                                                                       value="sp<?php echo $product_id ?>" style="width: 605px"
                                                                       /></div>
                    ...
                    <div class="wrap-input" style="   width: 720px;">
                        ...
                        <div class="value" style="width: 620px"><input type="text" id="title" 
                                                                       value="title<?php echo $product_id ?>" style="width: 605px"
                                                                       /></div>
                    ...
                    <div class="wrap-input" style="   width: 720px;">
                        ...
                        <div class="value" style="width: 620px"><input type="text" id="meta-description" 
                                                                       value="mtn<?php echo $product_id ?>" style="width: 605px"
                                                                       /></div>
                ...
                <div style="text-align:justify;line-height:150%; padding:10px;clear:both">
                    ...
                    <div class="editor" style="display: block;width: 100%;height: 480px">
                        <textarea id="description">mt<?php echo $product_id ?></textarea>
                    </div>
                    <div>
                                               <div style="padding-top: 10px;width: 400px;float: left;color: red;" id="error"></div>

                        <input type="button" id="add-product" class="post" value="Thêm sản phẩm" style="padding: 5px;
                               margin: 5px;
                               margin-right: 0;
                               float: right;"/></div>
                    <div style="clear:both"></div>
...
margin: auto;"></div>
                    ...
                    <div style="width: 100%;display: block;margin: 10px;margin-left: auto;margin-right: auto">
                        <img id="thumb" src="<?php echo $image?>" style="display: block;margin-left: auto;margin-right: auto"/>
                    </div>
                </div>
